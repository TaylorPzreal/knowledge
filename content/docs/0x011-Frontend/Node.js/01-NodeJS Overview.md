...
## 七、CheatSheet
1. [NodeJS Security Cheat Sheet](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/Nodejs_Security_Cheat_Sheet.md)
2. [Github NodeJS CheatSheet](https://github.com/LeCoupa/awesome-cheatsheets/blob/master/backend/node.js) 
...
Connect is an extensible HTTP server framework for nodejs using "plugins" known as _middleware_.
