...
> 3. TypeScript Release news <https://devblogs.microsoft.com/typescript/>
> 
> Books
> 1. 《Programming TypeScript》 by Boris Cherny
> 2. 《Effective TypeScript》 by Dan Vanderkam
> 3. 《TypeScript Exercises: A series of interactive exercises to practice TypeScript》
> 4. 《TypeScript-Handbook: A comprehensive guide to TypeScript》
> 5. **TypeScript Deep Dive** <https://github.com/basarat/typescript-book> 
...
**[TypeScript](https://www.typescriptlang.org/)** 由 Microsoft 开发和维护（2012年10月发布），是一种**面向对象**的开源编程语言。它是 **JavaScript 的超集**，包含可选类型。此外，它还可以编译为纯 JavaScript。
...
## 四、Development
`tsc` [tsc cli options](https://www.typescriptlang.org/docs/handbook/compiler-options.html#using-the-cli) 
`ts-node` [ts-node](https://github.com/TypeStrong/ts-node) is a TypeScript execution and REPL for node.js, with source map and native ESM support.


```sh
npm install --save-dev typescript

# bootstrap a tsconfig
tsc --init
```
...
## Useful Packages
- [zod](https://github.com/colinhacks/zod): A TypeScript-first data validation library
- [ts-morph](https://github.com/dsherret/ts-morph): A TypeScript-first API for manipulating TypeScript code
- [ts-node](https://github.com/TypeStrong/ts-node): A TypeScript execution and REPL for node.js
...
3. What is TypeScript <https://thenewstack.io/what-is-typescript/> 
